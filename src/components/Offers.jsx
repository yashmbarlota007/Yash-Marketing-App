            ...
            return (
              ...
              >
                <div>
                  ...
                  <h4 className="font-black text-gray-800 text-[10px] leading-snug line-clamp-3">
                    {sch.message}
                  </h4>
                  <p className="text-[9px] text-red-600 font-black mt-1 uppercase line-clamp-2">
                    🎁 {sch.reward}
                  </p>
                </div>
